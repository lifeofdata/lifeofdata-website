...
/ |/ |  /  \_/  |  |/-----|/  /  |  |  |/  /  |   |/ \_|/ \   |/ \_
  |  |_/\__/ \_/|_/|__/   |__/\_/|_/|_/|__/   |_/o|__/ |   |_/|__/ 
                                                 /|          /|    
                                                 \|          \|   
node-later.php

		finds 'later' nodes for this node and dumps them out as an UL
...
?>
<nav>
<h2>Later Stations</h2>
	<ul class="later sign <?php echo($node['category']); ?>">
<?
		$last_category=-1;
		$outer_open=false;
...
?>
		<li>
			<a class="tile later <?php echo($__slod_track_class); ?>" href="<?php echo(get_the_permalink() ); ?>">
